...
int main(int argc, const char* argv[])
{
	...
	reader.InitLicense("LICENSE-KEY"); // Get a valid license from https://www.dynamsoft.com/CustomerPortal/Portal/Triallicense.aspx
	...
	if(argc<=1)
	{
		printf("Powered by Dynamsoft Barcode Reader SDK\n");
		printf("---------------------------------------\n\n");
		printf("Usage: barcode-reader [ImageFilePath]\n");
		return 1; 
	}
	int iLen;
	iLen = strlen(argv[1]);
